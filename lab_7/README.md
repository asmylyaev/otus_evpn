## Цель
- Настроить MLAG
- host 1 собрать в MLAG, который сможет взамидействовать с растянутыми vlan 40, 50
- host 2 собрать в MLAG, который сможет взамидействовать, только с vlan 40
...
# Настройка MLAG
Настройка UNDERLAY и OVERLAY не изменялась с предыдущего задания. В данном задании, настройка MLAG
